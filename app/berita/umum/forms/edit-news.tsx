// app/berita/umum/forms/edit-news.tsx
  ...
  useEffect(() => {
    if (news) {
      setFormData({
        ...
        is_announcement: news.is_announcement || false,
        author: news.author || 'Admin Desa'
      })
    }
  }, [news])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Gagal mengupdate berita: ${error.error || 'Unknown error'}`)
      }
    } catch (error) {
      ...
      <div className="bg-white rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white p-6 border-b rounded-t-xl">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-800">Edit Berita</h2>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Form fields sama seperti AddNewsForm */}
          <div>
