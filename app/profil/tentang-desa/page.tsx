            ...
            <div className="lg:col-span-2">
              <div className="prose max-w-none">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Desa Rejoagung adalah salah satu dari 10 desa yang terletak di wilayah Kecamatan Srono, Kabupaten Banyuwangi, Provinsi Jawa Timur. Dengan luas wilayah mencapai 6,7776 km², Desa Rejoagung memiliki struktur wilayah yang terdiri dari empat dusun, yaitu Dusun Sumberagung, Sumberagung Kidul, Sumbergroto, dan Sumbergroto Kidul. Keempat dusun ini terbagi ke dalam 4 Rukun Warga (RW) dan 50 Rukun Tetangga (RT), menjadikan desa ini sebagai salah satu wilayah dengan tata kelola sosial yang cukup aktif dan dinamis.
                </p>
                <p className="text-gray-600 mb-6 leading-relaxed">
