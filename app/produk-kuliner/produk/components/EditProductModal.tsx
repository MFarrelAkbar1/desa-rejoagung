...
export default function EditProductModal({ item, onClose, onSuccess }: EditProductModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await ApiHelper.updateProduct(item.id, formData)
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 rounded-t-xl">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold">Edit Produk Unggulan</h2>
            ...
            {formData.image_url ? (
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                ...
                <div className="text-sm text-gray-600 mb-2">
                  <label htmlFor="image-upload-product-edit" className="cursor-pointer text-blue-600 hover:text-blue-700 font-medium">
