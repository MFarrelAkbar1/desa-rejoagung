...
interface AddKesehatanModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (data: any) => void
}

export default function AddKesehatanModal({ 
  isOpen, 
  onClose, 
  onSave 
}: AddKesehatanModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log('Adding layanan kesehatan:', data)
    onSave(data)
    onClose()
  }
