      ...
      style={{
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className={`flex items-center space-x-3 ${!isOpen && 'justify-center'}`}>
            <div className="w-10 h-10 bg-gradient-to-r from-green-400 to-green-600 rounded-lg flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-lg">R</span>
            </div>
            {isOpen && (
              <div>
                <h1 className="text-white font-bold text-lg">Desa Rejoagung</h1>
                <p className="text-gray-400 text-xs">Portal Resmi</p>
              </div>
            )}
          </div>
          <button
        ...
        {isOpen && (
          <div className="absolute bottom-4 left-4 right-4">
            <div className="bg-gray-700 rounded-lg p-3 text-center">
              <p className="text-gray-300 text-xs mb-1">Portal Desa</p>
              <p className="text-white font-semibold text-sm">Rejoagung</p>
